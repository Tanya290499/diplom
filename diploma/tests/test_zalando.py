...
import allure
from Tatyana_Malahova.diplom.conftest import driver
from diploma.pages.registration_page import RegistrationPage
from diploma.pages.home_page import HomePage
