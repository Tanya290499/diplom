...
def test_cart_add(driver):
    ...
    home_page.open()
    title = home_page.add_item_to_cart()
    home_page.go_to_cart_page()

    cart_page.check_item_was_added_to_cart(title)
    cart_page.check_is_items_in_cart()
...
def test_cart_remove(driver):
    ...
    cart_page.check_is_items_in_cart('1')
    cart_page.remove_item_from_cart()
    time.sleep(2)
    cart_page.check_is_items_in_cart('0')
